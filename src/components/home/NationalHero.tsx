...
import { ArrowRight, MapPin, Users, Fuel } from 'lucide-react'
    ...
    <section className="relative overflow-hidden bg-navy-900 text-white india-map-bg">
      ...
      <div className="container relative py-20 md:py-28 lg:py-36">
        <div className="max-w-4xl">
          <div className="inline-flex items-center gap-2 rounded-full border border-gold-600/30 bg-gold-600/10 px-4 py-1.5 text-sm text-gold-300 mb-6">
            <span className="h-2 w-2 rounded-full bg-gold-400 animate-pulse" />
            Exclusive National Partner of iFuel — PAN India Mandate
          </div>

          <h1 className="font-serif text-4xl md:text-5xl lg:text-6xl font-bold leading-tight tracking-tight text-balance text-white">
            Powering India's{' '}
            <span className="text-gold-400">Decentralized Fuel</span>{' '}
            Revolution
          </h1>
          ...
          <div className="mt-10 flex flex-wrap gap-4">
            ...
            <Button asChild variant="outline" size="xl" className="bg-white/5 border-white/30 text-white hover:bg-white/10">
          ...
          <div className="mt-16 grid grid-cols-2 md:grid-cols-4 gap-6 max-w-3xl">
            ...
            <HeroStat icon={ArrowRight} value="₹3.5/L" label="Network Margin" />
          </div>
        </div>
      </div>
    </section>
